# Contributing to `web3studio-data`

Looking to contribute something to Web3Studio Data? **Here's how you can help.**
...
`web3studio-data` is a monorepo that uses [yarn](https://yarnpkg.com) and [lerna](https://lernajs.io/)
...
`web3studio-data` uses [Semver](https://semver.org/) for versioning. Based on the changes
